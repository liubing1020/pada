...
{
  (*f) = exp(transform(x[0])*transform(x[1])*transform(x[2])*transform(x[3])*transform(x[4]));
  g[0] = fabs(transform(x[0])*transform(x[0])+transform(x[1])*transform(x[1])+transform(x[2])*transform(x[2])+transform(x[3])*transform(x[3])+transform(x[4])*transform(x[4])-10)  \
           -shareDefMinZero;
  g[1] = fabs(transform(x[1])*transform(x[2])-5*transform(x[3])*transform(x[4]))-shareDefMinZero;
  g[2] = fabs(pow(transform(x[0]),3)+pow(transform(x[1]),3)+1)-shareDefMinZero;
