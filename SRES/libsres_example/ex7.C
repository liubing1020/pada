...
{
  (*f) = transform(x[0])*transform(x[0])+transform(x[1])*transform(x[1])+transform(x[0])*transform(x[1])-14*transform(x[0])-16*transform(x[1])+(transform(x[2])-10)*(transform(x[2])-10)  \
         +4*(transform(x[3])-5)*(transform(x[3])-5)+(transform(x[4])-3)*(transform(x[4])-3)+2*(transform(x[5])-1)*(transform(x[5])-1)  \
         +5*transform(x[6])*transform(x[6])+7*(transform(x[7])-11)*(transform(x[7])-11)+2*(transform(x[8])-10)*(transform(x[8])-10)  \
         +(transform(x[9])-7)*(transform(x[9])-7)+45;
  g[0] = -105+4*transform(x[0])+5*transform(x[1])-3*transform(x[6])+9*transform(x[7]);
  g[1] = 10*transform(x[0])-8*transform(x[1])-17*transform(x[6])+2*transform(x[7]);
  g[2] = -8*transform(x[0])+2*transform(x[1])+5*transform(x[8])-2*transform(x[9])-12;
  g[3] = 3*(transform(x[0])-2)*(transform(x[0])-2)+4*(transform(x[1])-3)*(transform(x[1])-3)+2*transform(x[2])*transform(x[2])-7*transform(x[3])-120;
  g[4] = 5*transform(x[0])*transform(x[0])+8*transform(x[1])+(transform(x[2])-6)*(transform(x[2])-6)-2*transform(x[3])-40;
  g[5] = transform(x[0])*transform(x[0])+2*(transform(x[1])-2)*(transform(x[1])-2)-2*transform(x[0])*transform(x[1])+14*transform(x[4])-6*transform(x[5]);
  g[6] = 0.5*(transform(x[0])-8)*(transform(x[0])-8)+2*(transform(x[1])-4)*(transform(x[1])-4)+3*transform(x[4])*transform(x[4])-transform(x[5])-30;
  g[7] = -3*transform(x[0])+6*transform(x[1])+12*(transform(x[8])-8)*(transform(x[8])-8)-7*transform(x[9]);
