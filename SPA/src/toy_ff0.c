...
double tmp;
int i,j,k,ctr;
fin = fopen("../models/toy/toydata.txt","r");
...
snprintf(buffer, sizeof(buffer), "../models/toy/ctn/tables/toyPx1T%d.txt", tb);
fin = fopen(buffer, "r");
...
snprintf(buffer, sizeof(buffer), "../models/toy/ctn/tables/toyPx2T%d.txt", tb);
fin = fopen(buffer, "r");
while (fgets(buffer, sizeof(buffer), fin)) {
cp = (char *)strtok(buffer, "\t, ");
idx=strtol(cp, NULL, 0);
...
snprintf(buffer, sizeof(buffer), "../models/toy/ctn/tables/toyPx3T%d.txt", tb);
fin = fopen(buffer, "r");
while (fgets(buffer, sizeof(buffer), fin)) {
cp = (char *)strtok(buffer, "\t, ");
idx=strtol(cp, NULL, 0);
...
snprintf(buffer, sizeof(buffer), "../models/toy/ctn/tables/toyPx4T%d.txt", tb);
fin = fopen(buffer, "r");
while (fgets(buffer, sizeof(buffer), fin)) {
cp = (char *)strtok(buffer, "\t, ");
idx=strtol(cp, NULL, 0);
