...
for(tb=0;tb<100;tb++){
snprintf(buffer, sizeof(buffer), "../models/toy/mpict/toyCTx1T%d_%d.txt", tb,myid);
out=fopen(buffer, "w");
idx=0;
...
fclose(out);
snprintf(buffer, sizeof(buffer), "../models/toy/mpict/toyCTx2T%d_%d.txt", tb,myid);
out=fopen(buffer, "w");
idx=0;
...
fclose(out);
snprintf(buffer, sizeof(buffer), "../models/toy/mpict/toyCTx3T%d_%d.txt", tb,myid);
out=fopen(buffer, "w");
idx=0;
...
fclose(out);
snprintf(buffer, sizeof(buffer), "../models/toy/mpict/toyCTx4T%d_%d.txt", tb,myid);
out=fopen(buffer, "w");
idx=0;
