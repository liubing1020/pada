...
<!-- generated with COPASI 4.4.29 (development) (http://www.copasi.org) at 2009-08-04 10:29:45 UTC -->
<COPASI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.copasi.org/static/schema.xsd" versionMajor="1" versionMinor="0" versionDevel="29">
  ...
  <Model key="Model_1" name="New Model" timeUnit="s" volumeUnit="ml" quantityUnit="mmol" type="deterministic">
    ...
    <ListOfMetabolites>
      ...
      <Metabolite key="Metabolite_1" name="ES" simulationType="reactions" compartment="Compartment_0">
      </Metabolite>
      <Metabolite key="Metabolite_2" name="S" simulationType="reactions" compartment="Compartment_0">
      </Metabolite>
    ...
    <ListOfReactions>
      <Reaction key="Reaction_0" name="reaction" reversible="true">
        ...
        <ListOfConstants>
          <Constant key="Parameter_95" name="k1" value="0.1"/>
          <Constant key="Parameter_94" name="k2" value="0.1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_1" name="reaction_1" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_528" name="k1" value="0.1"/>
        </ListOfConstants>
    ...
    <InitialState type="initialState">
      0 5.419927350000001e+021 8.129891025000002e+021 6.022141500000001e+020 9.033212250000002e+020 0.1 0.1 0.3 1
    </InitialState>
  </Model>
  <ListOfTasks>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Maximum" type="float" value="13"/>
      ...
      <Problem>
        ...
        <ParameterGroup name="Experiment Set">
          <ParameterGroup name="Experiment">
            ...
            <Parameter name="File Name" type="file" value="toydata.txt"/>
            ...
            <ParameterGroup name="Object Map">
              ...
              <ParameterGroup name="1">
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[E],Reference=Concentration"/>
                <Parameter name="Role" type="unsignedInteger" value="2"/>
              </ParameterGroup>
              <ParameterGroup name="2">
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[ES],Reference=Concentration"/>
                <Parameter name="Role" type="unsignedInteger" value="2"/>
              </ParameterGroup>
              <ParameterGroup name="3">
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[S],Reference=Concentration"/>
                <Parameter name="Role" type="unsignedInteger" value="2"/>
              </ParameterGroup>
              <ParameterGroup name="4">
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[P],Reference=Concentration"/>
                <Parameter name="Role" type="unsignedInteger" value="2"/>
              </ParameterGroup>
            </ParameterGroup>
    ...
    <PlotSpecification name="plot" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        ...
        <PlotItem name="[ES]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=New Model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[ES],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[P]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=New Model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[P],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
